...
- [x] **Phase 2: Memory Model** - Separate durable memory from raw traces and establish the memory record shape. (completed 2026-06-21)
...
- [x] 02-01-PLAN.md — Add additive tags column (migration 0007) + storage support, and document read-only memory inspection queries
